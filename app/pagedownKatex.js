...
angular.module("pagedownKatex")
    .directive("pagedownKatexEditor", ['$compile', '$timeout', '$window', '$q', 'katexHtmlRenderer', function ($compile, $timeout, $window, $q, katexHtmlRenderer) {
        var nextId = 0;
        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                converter.hooks.chain("postConversion", function (text) {
                    ...
                    var renderedHtml = katexHtmlRenderer.getRenderedHtml(text, options);

                    scope.previewContent = renderedHtml;
                    return renderedHtml;
                });
    ...
    .directive("pagedownKatexViewer", ['$compile', '$sce', function ($compile, $sce) {
        var converter = Markdown.getSanitizingConverter();
        Markdown.Extra.init(converter, mdExtraOptions);
